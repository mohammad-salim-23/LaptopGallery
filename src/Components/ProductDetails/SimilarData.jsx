            ...
            <div class="w-80 h-[500px] p-4 bg-white shadow-md rounded-xl hover:shadow-xl mt-6 md:mt-3 lg:mt-0">
                <a href="#" className="">
                    <a href={`/productDetails/${product._id}`}>
                        <img src={product.images.img1 || "https://images.unsplash.com/photo-1646753522408-077ef9839300?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwcm9maWxlLXBhZ2V8NjZ8fHxlbnwwfHx8fA%3D%3D&auto=format&fit=crop&w=500&q=60"} className="rounded-xl h-52 duration-1000 hover:scale-105" />
                    </a>
                    <div class="p-2 w-72">
                        <a href={`/productDetails/${product._id}`}>
